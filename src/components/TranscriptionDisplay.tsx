  ...
  return (
    <Card className="w-full">
      <CardHeader className="flex flex-row items-center justify-between space-x-4">
        <CardTitle className="text-volcanic-800">Transcription</CardTitle>
        <div 
          className={`text-sm ${
            isInitializing 
              ? 'text-yellow-500' 
      ...
      <CardContent>
        <div className="mb-4">
          <h3 className="text-sm font-medium mb-2 text-volcanic-800">Speakers</h3> 
        ...
        <Tabs defaultValue="raw" className="w-full">
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="raw" className="text-volcanic-800">Raw Transcript</TabsTrigger> 
            <TabsTrigger value="enhanced" className="text-volcanic-800">Speaker Identified Transcript</TabsTrigger>
          </TabsList>
                ...
                <AnimatePresence mode="popLayout">
                  ...
                  {isRecording && (
                    <motion.span
                      ...
                      className="inline-block ml-1 text-volcanic-800" 
                    >
                      ●
                    </motion.span>
                  )}
                  ...
                  <div className="text-gray-500 text-center py-4">
                    {isRecording ? (
                      ...
                      <div className="flex flex-col items-center gap-2">
                        <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-volcanic-800"></div>
